...
when creating the app definition for tthis app ensure the following

- location is set to entry field
...
Execute create-contentful-app with npm, npx or yarn to bootstrap he example:
